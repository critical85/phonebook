            ...
            <form method="post">
                ...
                <div class="col-sm text-center" style="padding-top:10px; margin:10px">
                    ...
                    <div class="form-group mx-auto" style="max-width:200px; margin-top:20px">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $name_edit; ?>">
                    ...
                    <div class="form-group mx-auto" style="max-width:200px">
                        ...
                        <input type="tel" class="form-control" id="number" name="number" value="<?php echo $number_edit; ?>">
                    ...
                    <form method="post">
                        <tr>
                            <th style="display:none" scope="row">
                                <input type="number" class="form-control table-id" readonly="readonly" name="id" value="<?php echo $contact['id']; ?>">
                            </th>
                            <td>
                                <input type="text" style="width:auto" class="form-control table-id" readonly="readonly" name="name" value="<?php echo $contact['name']; ?>">
                            </td>
                            <td>
                                <input type="number" class="form-control table-id" readonly="readonly" name="number" value="<?php echo $contact['phone']; ?>">
                            </td>
                            <td style="width:1px" class="table-del-btn">
                                <button type="submit" class="btn btn-secondary bg-dark" name="delete_btn">Delete</button>
                            </td>
                            <td class="table-edit-btn">
                                <button type="submit" class="btn btn-secondary bg-dark" name="edit_btn">Edit</button>
                            </td>
                        </tr>
                    </form>
                    <?php } ?>
